<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="GruplariOku.aspx.cs" Inherits="GruplariOku" %>
...
<script type="text/javascript">
 function sleep(milliseconds) {
    ...
    var map; 
    <%=Session["MapCenter"] %> //haritanın orta nokta koordinatı ve zoomLevel
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="KoordinatPanel" style="margin-left:1px;border:1px solid dodgerblue;text-align:center ;width:200px; height:600px; overflow: auto">
        <input id="btnGrupGetir" type="button" value="Read Groups" 
            
            onclick="javascript:grupOlustur();document.getElementById('btnPoligonOlustur').disabled=false;document.getElementById('btnGrupGetir').disabled=true;" /><br />
        <input 
            id="btnPoligonOlustur" type="button" value="Draw Polygons" 
            
            onclick="javascript:PoligonOlustur();document.getElementById('btnPoligonOlustur').disabled=true;" 
            disabled="disabled" /><br />
        Group Coordinates
    <asp:TextBox ID="txtKoordinat" runat="server" Height="498px" TextMode="MultiLine" 
        Width="170px" style="background-color: #FFFFCC" Font-Names="Arial" 
