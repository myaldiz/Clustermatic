<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="GrupYolTarifiMesafe.aspx.cs" Inherits="GrupYolTarifiMesafe" %>
...
<%=Session["MapCenter"] %>
    ...
    */
    ...
    for (i = 0; i < myroute.legs.length; i++) 
     ...
     total = total / 1000.
     document.getElementById("total").innerHTML = "Toplam Mesafe: <b>" + total + " km</b>";
    }
        <%=Session["YolTarif1"]%>
...
//        }
   ...
   function attachPolygonInfoWindow(polygon, html)
    ...
    function calcRoute(baslangic,bitis) {
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="margin:1px 0 1px 1px;border: 1px solid dodgerblue;text-align:center;width:300px; height:43px;color:red"> 
        ...
        Click here to find distance to polygon</div>    
     <div id="total" 
            style="margin:1px 0 1px 1px;border: 1px solid dodgerblue;text-align:center;width:300px; height:20px;color:black; font-size: small;">
         Distances:</div>
     <div id="divmesafe" 
            style="margin-left:1px;border: 1px solid dodgerblue;text-align:center; width:300px; height:527px; overflow: auto">
    &nbsp;<asp:TextBox ID="txtMesafe" runat="server" Height="506px" TextMode="MultiLine" 
             Width="260px" style="background-color: #FFFFCC"></asp:TextBox>
    </div>   
    <div id="directionsPanel" style="margin-left:1px;border: 1px solid dodgerblue;text-align:left;width:300px; height:5px; overflow: auto">
