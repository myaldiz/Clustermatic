...
public partial class GruplariOku : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            txtKoordinat.Text = txtKoordinat.Text + Satirlar[i] + "\n";
        }        
        ...
        for (i = 0;i<Satirlar.Length ; i++)
        {
         ...
         "}\n";
               ...
               "});\n" +
                ...
                "attachPolygonInfoWindow(grupPoligon" + gSayi.ToString() + ", \" <strong>Group  "+gSayi.ToString() +" Polygon</string>\")" +
